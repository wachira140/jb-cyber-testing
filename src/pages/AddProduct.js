...
const AddProduct = () => {
    ...
    const {
      ...
      const categories = all_products.products.map((item) => item.category.toLowerCase())
    const uniqueCategories = ['category',...new Set(categories)]

        if(submit_product.loading){
    return(
        <Wrapper>
...
if(submit_product.error){
    return(
        <Wrapper>
            <div className='loading center error'>
            <h5>{submit_product.msg}</h5>
            <h5 className='btn' onClick={resetForm}>try again</h5>
            </div>
        </Wrapper>
    )
}
if(submit_product.success){
    return(
        <Wrapper>
            <div className='loading center success'>
            <h5>{submit_product.msg}</h5>
            <h5 className='btn' onClick={resetFormSuccess}>add more</h5>
            </div>
        </Wrapper>
    )
}
